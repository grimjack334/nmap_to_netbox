...
> `oneview_to_netbox.py` (HP OneView → NetBox sync) moved to the [`netbox-manual`](../netbox-manual) repo — see [`ONEVIEW_TO_NETBOX.md`](../netbox-manual/ONEVIEW_TO_NETBOX.md) there.
